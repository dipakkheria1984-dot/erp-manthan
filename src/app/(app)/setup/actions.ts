...
const configSchema = z
  .object({
    ...
    overdueReminderMaxCount: intInput("Maximum overdue reminders", { min: 0, max: 100 }),
    emailNotificationsEnabled: checkboxInput,
    whatsappNotificationsEnabled: checkboxInput,
